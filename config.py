...
class BotConfig:
    ...
    injector_path: Path = Path("C:\\Users\\Gold\\Desktop\\Extreme Injector v3.exe") # Exemplo, usuario deve alterar
    core_dll_path: Path = Path("C:\\hb\\league of legends\\core.dll")
    game_cfg_general: Dict[str, str] = field(
        default_factory=lambda: {"WindowMode": "2", "Height": "1440", "Width": "2560"})
